...
public class OrderDAOImpl implements OrderDAO {
    ...
    @Override
    public List<Order> getAll(UUID customerID) throws SQLException {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        ...
        try {
            connection = DatabaseConnector.connect();
            preparedStatement = connection.prepareStatement("SELECT id, status, creation_date, total_price, customer_id, content, total_price_after_discount, discount FROM orders WHERE customer_id = ?");
