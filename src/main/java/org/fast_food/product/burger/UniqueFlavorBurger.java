...
public enum UniqueFlavorBurger implements Burger {
    BREAKFAST("Breakfast Burger", 8.99, List.of(Patty.BEEF, Ingredient.BACON, Ingredient.FRIED_EGG, Ingredient.LETTUCE, Ingredient.TOMATO), "Start your day right with this hearty breakfast burger featuring a juicy beef patty, crispy bacon, a perfectly fried egg, and fresh lettuce and tomato.", 780, 2, 4.0),
    MOZZARELLA("Mozzarella Burger", 8.99, List.of(Patty.BEEF, Cheese.MOZZARELLA, Sauce.MARINARA, Ingredient.LETTUCE, Ingredient.TOMATO), "Indulge in the cheesy goodness of melted mozzarella cheese atop a juicy beef patty, complemented by tangy marinara sauce, lettuce, and tomato.", 820, 1, 3.6),
    ...
    BLUEBERRY_BBQ_BACON("Blueberry BBQ Bacon", 11.99, List.of(Patty.BEEF, Ingredient.BACON, Ingredient.CARAMELIZED_ONIONS, Cheese.CHEDDAR, Ingredient.BLUEBERRY, Sauce.BLUEBERRY_BBQ), "Experience a burst of sweet and savory flavors with this unique burger featuring blueberry BBQ sauce, crispy bacon, melted cheddar cheese, and caramelized onions atop a juicy beef patty.", 850, 1, 4.5),
