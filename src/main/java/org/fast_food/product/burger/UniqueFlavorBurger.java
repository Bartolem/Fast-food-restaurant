...
public enum UniqueFlavorBurger implements Burger {
    BREAKFAST("Breakfast Burger", 8.99, List.of(Patty.BEEF, Ingredient.BACON, Ingredient.FRIED_EGG, Ingredient.LETTUCE, Ingredient.TOMATO), "Start your day right with this hearty breakfast burger featuring a juicy beef patty, crispy bacon, a perfectly fried egg, and fresh lettuce and tomato.", 780, 2, 4),
