...
public enum ComboMeal implements Product, Burger<Product> {
    CLASSIC("Classic Combo Meal", 9.99, List.of(ClassicBurger.CLASSIC_CHEESEBURGER, FrenchFries.REGULAR, ColdDrink.COLA_DRINK), "Classic Cheeseburger with Regular Fries and Cola Drink", 1120, 1, 4.8),
    VEGGIE_DELIGHT("Veggie Delight Combo Meal", 10.99, List.of(ClassicBurger.VEGGIE, FrenchFries.SWEET_POTATO, ColdDrink.SPINACH_SMOOTHIE), "Veggie Burger with Sweet Potato Fries and Spinach Smoothie", 980, 1, 4.2),
    BREAKFAST("Breakfast Combo Meal", 8.49, List.of(UniqueFlavorBurger.BREAKFAST, FrenchFries.CURLY, HotDrink.ESPRESSO), "Bacon Egg Burger with Curly Fries and Espresso Coffee", 900, 1, 4.5),
    GOURMET("Gourmet Combo Meal", 12.99, List.of(GourmetBurger.BLUE_CHEESE, FrenchFries.LOADED_FRIES, ColdDrink.PINEAPPLE_PINA_COLADA), "Blue Cheese Burger with Sweet Potato Fries and Pineapple Piña Colada", 1180, 2, 4.0),
    ...
    SPICY("Spicy Combo Meal", 9.99, List.of(SpicyBurger.SPICY_SRIRACHA, FrenchFries.REGULAR, ColdDrink.MINT_COCKTAIL), "Spicy Sriracha Burger with Regular Fries and Mint Cocktail", 980, 4, 3.6),
    INFERNO("Inferno Combo Meal", 11.49, List.of(SpicyBurger.INFERNO, FrenchFries.REGULAR, ColdDrink.COLA_DRINK), "Inferno Burger with Regular Fries and Cola Drink", 1150, 5, 3.8),
    ...
    ULTIMATE("Ultimate Combo Meal", 13.99, List.of(ClassicBurger.DOUBLE_BACON_CHEESEBURGER, FrenchFries.LOADED_FRIES, ColdDrink.CHOCOLATE_MILKSHAKE), "Double Bacon Cheeseburger with Loaded Fries and Chocolate Milkshake", 1450, 3, 3.9),
    HEALTHY("Healthy Combo Meal", 10.49, List.of(ClassicBurger.TURKEY, Side.QUINOA_SALAD, ColdDrink.ORANGE_JUICE), "Turkey Burger with Quinoa Salad and Orange Juice", 920, 1, 3.7),
    ITALIAN("Italian Inspired Combo Meal", 11.99, List.of(GourmetBurger.PESTO_TURKEY, FrenchFries.GARLIC_PARMESAN, ColdDrink.CARAMEL_ICED_COFFEE), "Pesto Turkey Burger with Garlic Parmesan Fries and Caramel Iced Coffee", 1050, 1, 3.8),
    ...
    TRUFFLE("Truffle Combo Meal", 12.99, List.of(GourmetBurger.TRUFFLE_MUSHROOM, FrenchFries.LOADED_FRIES, ColdDrink.BLUEBERRY_SMOOTHIE), "Truffle Mushroom Burger with Loaded Fries and Blueberry Smoothie", 1350, 2, 3.6),
