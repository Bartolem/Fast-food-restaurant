...
public enum GourmetBurger implements Burger {
    BLUE_CHEESE_BURGER("Blue Cheese Burger", 6.99, List.of(Ingredient.BEEF_PATTY, Cheese.BLUE_CHEESE, Ingredient.LETTUCE, Ingredient.TOMATO, Ingredient.ONION), "A gourmet delight featuring a succulent beef patty topped with rich and tangy blue cheese, fresh lettuce, tomato, and onion.", 680, 1, 3.3),
    AVOCADO_RANCH_BURGER("Avocado Ranch Burger", 7.29, List.of(Ingredient.BEEF_PATTY, Ingredient.AVOCADO, Sauce.RANCH_DRESSING, Ingredient.TOMATO, Ingredient.ONION), "Indulge in the creamy goodness of avocado and the zesty flavor of ranch dressing on a perfectly grilled beef patty.", 720, 1, 3.5),
    TRUFFLE_MUSHROOM_BURGER("Truffle Mushroom Burger", 7.49, List.of(Ingredient.BEEF_PATTY, Sauce.TRUFFLE_OIL, Cheese.SWISS_CHEESE, Ingredient.SAUTEED_MUSHROOMS, Ingredient.LETTUCE), "A gourmet experience with truffle-infused mushrooms, Swiss cheese, and a juicy beef patty for a rich and earthy taste.", 780, 1, 3.8),
    GUACAMOLE_BACON_BURGER("Guacamole Bacon Burger", 7.79, List.of(Ingredient.BEEF_PATTY, Ingredient.GUACAMOLE, Ingredient.BACON,Ingredient.LETTUCE, Ingredient.TOMATO), "Savor the combination of creamy guacamole, crispy bacon, and a perfectly grilled beef patty.", 800, 1, 3.6),
    BBQ_RANCH_BACON_BURGER("BBQ Ranch Bacon Burger", 7.69, List.of(Ingredient.BEEF_PATTY, Sauce.BBQ_SAUCE, Sauce.RANCH_DRESSING, Ingredient.BACON, Ingredient.TOMATO), "A delicious fusion of BBQ and ranch flavors with the added crunch of bacon.", 830, 1, 4.2),
