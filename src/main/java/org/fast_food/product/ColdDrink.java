...
public enum ColdDrink implements Product {
    PEANUT_BUTTER_BANANA_SMOOTHIE("Peanut Banana Smoothie", 5.99, "Indulge in the creamy blend of peanut butter, ripe bananas, and rich chocolate, creating a decadent and satisfying smoothie.", 380),
    MANGO_SMOOTHIE("Mango Smoothie", 7.49, "Refresh your taste buds with the tropical sweetness of ripe mango blended into a smooth and creamy drink.", 220),
    ...
    MILKSHAKE_COOKIES_AND_CREAM("Cookie Milkshake", 6.49, "Treat yourself to the classic combination of creamy vanilla ice cream blended with chunks of chocolate cookies, creating a decadent and indulgent milkshake.", 550),
    ...
    STRAWBERRY_MILKSHAKE("Strawberry Milkshake", 6.99, "Elevate your milkshake experience with luscious strawberry flavor, topped with fluffy marshmallows and chocolate sticks for an extra indulgent touch.", 520),
