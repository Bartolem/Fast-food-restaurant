...
public enum GourmetBurger implements Burger {
    ...
    GUACAMOLE_BACON("Guacamole Bacon Burger", 7.79, List.of(Patty.BEEF, Ingredient.GUACAMOLE, Ingredient.BACON,Ingredient.LETTUCE, Ingredient.TOMATO, Bun.SESAME), "Savor the combination of creamy guacamole, crispy bacon, and a perfectly grilled beef patty.", 800, 1, 3.6),
    BBQ_RANCH_BACON("BBQ Ranch Bacon Burger", 7.69, List.of(Patty.BEEF, Sauce.BBQ_SAUCE, Sauce.RANCH_DRESSING, Ingredient.BACON, Ingredient.TOMATO, Bun.BRIOCHE), "A delicious fusion of BBQ and ranch flavors with the added crunch of bacon.", 830, 1, 4.2),
    CAJUN_SPICED("Cajun Spiced Burger", 6.89, List.of(Patty.BEEF, Ingredient.CAJUN, Cheese.PEPPER_JACK_CHEESE, Ingredient.LETTUCE, Ingredient.TOMATO, Bun.POTATO), "A spicy kick with Cajun seasoning and melted pepper jack cheese for a flavor-packed burger.", 690, 3.5, 4.1),
    PESTO_TURKEY("Pesto Turkey Burger", 7.19, List.of(Patty.TURKEY, Sauce.PESTO, Cheese.MOZZARELLA, Ingredient.ARUGULA, Ingredient.TOMATO, Bun.SESAME), "A lighter option with a turkey patty, topped with fresh pesto, melted mozzarella, arugula, and tomato.", 660, 1, 3.7),
