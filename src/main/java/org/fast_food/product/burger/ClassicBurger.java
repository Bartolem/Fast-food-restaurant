...
public enum ClassicBurger implements Burger {
    ...
    CHICKEN("Chicken Burger", 5.29, List.of(Patty.CHICKEN, Ingredient.LETTUCE,  Ingredient.TOMATO, Ingredient.PICKLES, Ingredient.ONION, Sauce.MAYO), "A grilled chicken burger with crisp veggies and mayo for a delightful flavor.", 550, 1, 4.3),
    TURKEY("Turkey Burger", 5.49, List.of(Patty.TURKEY, Ingredient.LETTUCE, Ingredient.TOMATO, Ingredient.ONION, Sauce.CRANBERRY_SAUCE), "A healthier option with a turkey patty and a touch of sweet cranberry sauce.", 550, 1, 4.0),
    BBQ("BBQ Burger", 5.99, List.of(Patty.BEEF, Sauce.BBQ_SAUCE, Ingredient.ONION_RINGS, Ingredient.LETTUCE), "A savory BBQ-infused burger with melted cheddar and crispy onion rings.", 680, 1.5, 4.3),
    JALAPENO("Jalapeño Burger", 5.59, List.of(Patty.BEEF, Cheese.PEPPER_JACK_CHEESE, Ingredient.JALAPENOS, Ingredient.LETTUCE, Ingredient.TOMATO), "A spicy delight with pepper jack cheese and a kick of jalapeños.", 640, 3, 3.8),
    TERIYAKI("Teriyaki Burger", 5.89, List.of(Patty.BEEF, Sauce.TERIYAKI_SAUCE, Ingredient.TOMATO, Ingredient.LETTUCE, Ingredient.TOMATO, Ingredient.PINEAPPLE), "A flavorful burger with a sweet and tangy teriyaki glaze and a hint of pineapple.", 600, 1, 4.2),
    ...
    DOUBLE_BACON("Double Bacon Burger", 6.99, List.of(Patty.BEEF, Patty.BEEF, Ingredient.BACON, Cheese.CHEESE, Ingredient.LETTUCE,  Ingredient.TOMATO, Ingredient.PICKLES, Ingredient.ONION), "For the ultimate bacon lover – double beef and crispy bacon.", 1120, 2, 4.6),
    DOUBLE_BACON_CHEESEBURGER("Double Bacon Cheeseburger", 7.19, List.of(Patty.BEEF, Patty.BEEF, Ingredient.BACON, Cheese.CHEESE, Cheese.CHEESE, Ingredient.LETTUCE,  Ingredient.TOMATO, Ingredient.PICKLES, Ingredient.ONION), "For the ultimate bacon and cheese lover – double beef, double cheese, and crispy bacon.", 1280, 2, 4.5);
