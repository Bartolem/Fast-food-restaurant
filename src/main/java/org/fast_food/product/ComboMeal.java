...
public enum ComboMeal implements Product, Burger<Product> {
    ...
    TRUFFLE("Truffle Combo Meal", 12.99, List.of(GourmetBurger.TRUFFLE_MUSHROOM, FrenchFries.LOADED_FRIES, ColdDrink.BLUEBERRY_SMOOTHIE), "Truffle Mushroom Burger with Loaded Fries and Blueberry Smoothie", 1350, 2, 4.6),
