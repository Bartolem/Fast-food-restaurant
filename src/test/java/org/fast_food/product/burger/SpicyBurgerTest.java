...
public class SpicyBurgerTest {
    ...
    void testGetIngredientsForDifferentBurgerTypes() {
        assertTrue(SPICY_SRIRACHA.getIngredients().containsAll(List.of(Ingredient.BEEF_PATTY, Sauce.SRIRACHA_SAUCE, Cheese.PEPPER_JACK_CHEESE, Ingredient.TOMATO, Ingredient.LETTUCE)));
        assertTrue(JALAPENO_POPPER.getIngredients().containsAll(List.of(Ingredient.BEEF_PATTY, Ingredient.JALAPENO_POPPER_FILLING, Cheese.CREAM_CHEESE, Ingredient.LETTUCE, Ingredient.TOMATO)));
        assertTrue(BUFFALO_CHICKEN.getIngredients().containsAll( List.of(Ingredient.CHICKEN, Sauce.BUFFALO_SAUCE, Sauce.BLUE_CHEESE_DRESSING, Ingredient.LETTUCE, Ingredient.TOMATO)));
        assertTrue(CHIPOTLE_BLACK_BEAN.getIngredients().containsAll(List.of(Ingredient.BLACK_BEAN_PATTY, Sauce.CHIPOTLE_MAYO, Cheese.PEPPER_JACK_CHEESE, Ingredient.LETTUCE, Ingredient.TOMATO)));
        assertTrue(CAJUN_SHRIMP.getIngredients().containsAll(List.of(Ingredient.SHRIMP_PATTY, Ingredient.CAJUN, Sauce.REMOULADE, Ingredient.LETTUCE, Ingredient.TOMATO)));
        assertTrue(GHOST_PEPPER.getIngredients().containsAll(List.of(Ingredient.BEEF_PATTY, Cheese.GHOST_PAPER_CHEESE, Sauce.GHOST_PEPPER_SAUCE, Ingredient.LETTUCE, Ingredient.TOMATO)));
        assertTrue(HOT_PEPPER_JACK.getIngredients().containsAll(List.of(Ingredient.BEEF_PATTY, Cheese.PEPPER_JACK_CHEESE, Ingredient.JALAPENOS, Ingredient.LETTUCE, Ingredient.TOMATO)));
        assertTrue(FIERY_HABANERO.getIngredients().containsAll(List.of(Ingredient.BEEF_PATTY, Sauce.HABANERO_SAUCE, Cheese.PEPPER_JACK_CHEESE, Ingredient.LETTUCE, Ingredient.TOMATO)));
        assertTrue(SPICY_THAI.getIngredients().containsAll(List.of(Ingredient.BEEF_PATTY, Sauce.THAI_CHILI_SAUCE, Sauce.PEANUT_SAUCE, Ingredient.CUCUMBER, Ingredient.LETTUCE)));
        assertTrue(INFERNO.getIngredients().containsAll(List.of(Ingredient.BEEF_PATTY, Ingredient.JALAPENOS, Ingredient.BANANA_PEPPERS, Cheese.GHOST_PAPER_CHEESE, Sauce.INFERNO_SAUCE, Ingredient.LETTUCE, Ingredient.TOMATO)));
    }
